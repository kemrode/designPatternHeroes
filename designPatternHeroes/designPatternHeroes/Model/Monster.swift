...
class Monster: Character {
    ...
    func fight() -> Int {
        print("le monstre \(self.name) attaque avec son \(self.weaponName) !")
    ...
    func loosePointsOfLife(attackStrength: Int) {
        ...
        print("Excellent \(self.name) perd \(result) points de vie !")
        print("Il rest \(self.pointsOfLife) points de vie à \(self.name)")
    }
    
    public func deadMonster() {
        print("\(self.name) est mort. Victoire !")
    }
